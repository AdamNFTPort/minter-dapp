const contractAddress = "0xBCe1F50265EB75B178C59a723A74c44099911846"; // Replace with your own contract address
const chain = 'rinkeby'; // rinkeby, polygon, or ethereum

const welcome_h1 = "Welcome to Adam's test NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'This NFT Project is a decentralized, open-source project using the NFTPort API, that aims to demonstrate how to develope and launch your own NFT Collection. Follow step by step on the <a href="https://youtube.com/codestackr"  target="_blank" rel="noopener noreferrer">codeSTACKr</a> YouTube channel.';
